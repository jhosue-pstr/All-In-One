...
class Page(BaseModel, TimestampMixin):
    ...
    gjs_data: Mapped[str | None] = mapped_column(Text, nullable=True)
    gjs_html: Mapped[str | None] = mapped_column(Text, nullable=True)
    gjs_css: Mapped[str | None] = mapped_column(Text, nullable=True)
